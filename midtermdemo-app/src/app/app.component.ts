...
export class AppComponent implements OnInit {
  ...
  username!:Observable<string>;
    constructor(@Inject(OKTA_AUTH) private oktaAuth:OktaAuth,private userService: UsersService, private tokenStorage: TokenStorageService, private router: Router, private oktaAuthStateService: OktaAuthStateService) { }
  ...
  ngOnInit():void {
   ...
   console.log('does this evaluate correctly? '+ this.user?.roles.includes('ROLE_ADMIN'));
    this.roles.forEach((k,v)=>{if ((k)='ROLE_ADMIN'){
